...
function OnJoystickControlled(strPara){
    ...
    if(btn_info[0] == '1'){
        PlaySpeech("Voyager: Imagine the Possibilities");

    }

    if(btn_info[1] == '1'){
        PlaySpeech("Expand your vision with Voyager");

    }
    if(btn_info[2] == '1'){
        PlaySpeech("Visit voyagercameras.com for all your observation needs");
    }
    if(btn_info[3] == '1'){
        PlaySpeech("Get the full picture with the auto-calibrating Voyager 360 camera system");
